#!/usr/bin/env python3
"""
Fine-tuning script template with DDP (Distributed Data Parallel) support
...
def setup_distributed():
    ...
    if rank == 0:
        print("=" * 70)
        print(" Distributed Fine-Tuning with DDP ".center(70))
        print("=" * 70)
...
[DATASET_PROCESSING_SECTION]
        ...
        training_args = TrainingArguments(
            ...
            ddp_bucket_cap_mb=[DDP_BUCKET_CAP][TRAINING_ARGS_EXTRA]
        )
...
if __name__ == "__main__":
    try:
        ...
        print(f"[Rank {rank}] Error during fine-tuning: {e}")
        import traceback
        traceback.print_exc()
